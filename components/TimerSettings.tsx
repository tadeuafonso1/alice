            ...
            <div className="max-w-xl">
                <div className="bg-gray-50 dark:bg-[#0f111a] p-6 rounded-2xl border border-gray-200 dark:border-gray-700 space-y-8">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="font-bold text-gray-900 dark:text-white text-lg">Ativar Timer</p>
                            <p className="text-sm text-gray-500 dark:text-[#8bcbd5]">O bot removerá quem não enviar mensagens por um tempo.</p>
                        </div>
                        <button
                    ...
                    <div className={`transition-all duration-300 ${isTimerActive ? 'opacity-100' : 'opacity-40 grayscale pointer-events-none'}`}>
                        ...
                        <div className="flex justify-between mt-2">
                            ...
                            <span className="text-xs font-bold text-gray-400 dark:text-[#8bcbd5]">15 min</span>
